...
function buildInstructions() {
  return [
    ...
    "Return HTML only. Use <b> for section headers and <i> for emphasis. Do not use Markdown.",
...
export async function buildAgenticTelegramSummary({ config, summary, state, tasksForToday }) {
